 ...
 */
export async function get_gpt_funcAICompletion(job) {
  /**
   ...
   * you have passed in the get_gpt_outputLongWork.js file
   * 
  ...
  return new Promise((resolve, reject) => {
    ...
    GetChatGPTOutput({
      ...
      prompt: getChatGPTFunctionPrompt({
        ...
        functionLanguage: job.data.functionLanguage,
        functionPurpose: job.data.functionPurpose,
        functionArgs: job.data.functionArgs,
        functionReturnValue: job.data.functionReturnValue,
      }),
