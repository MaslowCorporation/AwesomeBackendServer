...
import { getGoogleLoginCode } from "../../../../../services/GoogleLogin/GoogleLogin.js";

export async function google_loginLongWork(req, res) {
  ...
  const api_endpoint_name = "google_login";

  // get the login data quick so you can display it to the frontend
  const loginData = await getGoogleLoginCode(process.env.GOOGLE_CLIENT_ID)
