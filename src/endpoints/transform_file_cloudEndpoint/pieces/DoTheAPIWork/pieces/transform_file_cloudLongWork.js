...
export async function transform_file_cloudLongWork(req, res) {
  ...
  // (axios, etc...)
  const { first_asset_id_ext, transforms, params } = req.body;
  ...
  const api_endpoint_name = "transform_file_cloud";
  ...
  await AddJobInQueue({
    ...
    res,
    args: {
      first_asset_id_ext, transforms, params: paramsObj
    }
  });
}
