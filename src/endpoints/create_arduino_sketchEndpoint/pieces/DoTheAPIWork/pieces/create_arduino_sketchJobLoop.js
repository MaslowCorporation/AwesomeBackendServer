 ...
 */
export async function create_arduino_sketchJobLoop(job) {
  /**
   ...
   * you have passed in the create_arduino_sketchLongWork.js file.
   * 
   * 
  ...
  // This contains the job's data. 
  // The initial stuff the job uses to do it's thing.
  ...
  //
  // As long as the work hasn't reached 100% completion....
  while (!workDone) {
